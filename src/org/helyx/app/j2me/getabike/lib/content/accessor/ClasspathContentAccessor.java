...
import org.helyx.app.j2me.getabike.lib.stream.ClasspathInputStreamProvider;
...
public class ClasspathContentAccessor implements IContentAccessor {
	...
	private static final Logger logger = Logger.getLogger("CLASSPATH_CONTENT_ACCESSOR");
