 ...
 */
package org.helyx.app.j2me.getabike.lib.renderer.text;
...
public class I18NTextRenderer implements ITextRenderer {

	private AbstractMIDlet midlet;

	public I18NTextRenderer(AbstractMIDlet midlet) {
		super();
		this.midlet = midlet;
	}
	
	public String renderText(String textValue) {
		return midlet.getMessage(textValue);
	}
