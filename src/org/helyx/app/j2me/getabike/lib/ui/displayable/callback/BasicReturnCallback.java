...
public class BasicReturnCallback implements IReturnCallback {
	...
	private Logger logger = Logger.getLogger("BASIC_RETURN_CALLBACK");
	...
	public void onReturn(AbstractDisplayable currentDisplayable, Object data) {
		if (logger.isDebugEnabled()) {
			logger.debug("currentDisplayable: " + currentDisplayable);
			logger.debug("previousDisplayable: " + previousDisplayable);
		}
