...
public abstract class OkCancelResultCallback extends AbstractDialogResultCallback {
	
	public OkCancelResultCallback() {
		super(); 
	}
	...
	public abstract void onCancel(DialogView dialogView, Object data);

	public abstract void onOk(DialogView dialogView, Object data);
