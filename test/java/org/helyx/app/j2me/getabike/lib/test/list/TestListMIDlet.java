...
public class TestListMIDlet extends AbstractMIDlet {
	...
	protected void initLog() {
		...
		LoggerManager.addCategory("org.helyx.app.j2me.getabike.lib", Logger.DEBUG);
	}
	...
	protected void onStart() {
		...
		final StationListView stationListView = new StationListView(this, "Liste des stations");
//		stationListView.setCellRenderer(new StationItemRenderer());
		stationListView.show();
		stationListView.setScreenDragging(true);
		stationListView.loadListContent(new UIStationLoaderProgressListener(stationListView));
		stationListView.getViewCanvas().setDebug(false);
	}
